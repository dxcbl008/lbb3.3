...
const cn = {
  ...
  Export: {
    ...
    MessageFromChatGPT: "来自老北鼻AI 的消息",
    Format: {
      Title: "导出格式",
  ...
  Store: {
    DefaultTopic: "新的聊天",
    BotHello: "## ⛔紧急通知 \n**近期，用户访问量激增，官方大量处理账号，可能导致域名被污染、\n部分地区打不开等情况。为防止找不到我们请加入社群！！**\n## ✔请各位加入社群，谨防失联！！！\n![](https://cdn.lbbmj.com/ims/wxqun.jpg)\n## ⭐特别说明\n**老北鼻AI GPT最新域名：[Gpt.ai-vue.com](https://gpt.ai-vue.com)\n老北鼻AI导航最新域名：[Lbb.Ai](https://lbb.ai/)\n老北鼻AI 域名发布地址：[Links.Lbb.Ai](https://Links.Lbb.Ai)**",
    Error: "## 出错了，请刷新页面 如一直错误请联系管理员\n![](https://cdn.lbbmj.com/ims/wxqun.jpg)",
    Prompt: {
